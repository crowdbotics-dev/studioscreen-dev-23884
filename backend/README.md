...
## Project Structure
    ...
    ├── studioscreen_dev_23884  # Django project configurations
...
1. Clone this repo and `cd studioscreen_dev_23884`
...
2. Clone this repo and `cd studioscreen_dev_23884`
